    ...
    <div>
        ...
        <form wire:submit.prevent="login" class="form w-100" novalidate="novalidate">
            ...
            <div class="text-center mb-5">
                <img alt="Logo" class="mh-100px" src="{{asset('admin-assets/media/logos/ems-logo.png')}}" />
            </div>
            <!--end::Icon-->
            <!--begin::Heading-->
            <div class="text-center mb-11">
                <!--begin::Title-->
                <h1 class="text-gray-500 fw-bolder mb-3">Sign In</h1>
                <!--end::Title-->
                <!--begin::Subtitle-->
                <div class="text-gray-400 fw-semibold fs-6">Employee Management System - Employee</div>
                <!--end::Subtitle=-->
            </div>
            <!--begin::Heading-->
            ...
            <div class="fv-row mb-8">
                ...
                <!--end::Username-->
                @error('email')
                <div class="fv-plugins-message-container text-white text-danger">
                    {{ $message }}
                </div>
                @enderror
            </div>
