            ...
            <div class="row g-5 g-xl-8">
                ...
                <div class="col-xl-4">
                    ...
                    <a class="card bg-primary hoverable card-xl-stretch mb-5 mb-xl-8">
                        <!--begin::Body-->
                        <div class="card-body">
                            <div class="text-white fw-bold fs-2 mb-2 mt-5">{{\App\Models\Manager::count()}}</div>
                ...
                <div class="col-xl-4">
                    ...
                    <a class="card bg-success hoverable card-xl-stretch mb-5 mb-xl-8">
                        <!--begin::Body-->
                        <div class="card-body">
                            <div class="text-white fw-bold fs-2 mb-2 mt-5">{{\App\Models\Employee::count()}}</div>
                            <div class="fw-semibold text-white">
                                Total Employees
                            </div>
                        </div>
                ...
                <div class="col-xl-4">
                    ...
                    <a class="card bg-danger hoverable card-xl-stretch mb-5 mb-xl-8">
                        <!--begin::Body-->
                        <div class="card-body">
                            <div class="text-white fw-bold fs-2 mb-2 mt-5">{{\App\Models\TrainingProgram::count()}}</div>
                            <div class="fw-semibold text-white">
                                Total Programs
                            </div>
                        </div>
