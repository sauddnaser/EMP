            ...
            <div class="row g-5 g-xl-8">
                ...
                <div class="col-xl-6">
                    ...
                    <a class="card bg-primary hoverable card-xl-stretch mb-5 mb-xl-8">
                        <!--begin::Body-->
                        <div class="card-body">
                            <div class="text-white fw-bold fs-2 mb-2 mt-5">{{count(auth('manager')->user()->employees)}}</div>
                ...
                <div class="col-xl-6">
                    ...
                    <a class="card bg-success hoverable card-xl-stretch mb-5 mb-xl-8">
                        <!--begin::Body-->
                        <div class="card-body">
                            <div class="text-white fw-bold fs-2 mb-2 mt-5">{{auth('manager')->user()->count_programs}}</div>
                            <div class="fw-semibold text-white">
                                Total Programs
                            </div>
                        </div>
